...
Route::prefix('front_desk')
    ...
    ->group(function () {
        ...
        Route::get('/er-registration', [FrontDeskController::class, 'er_registration'])->name('er_registration');
        Route::post('/er-registration/store', [FrontDeskController::class, 'er_registration_store'])->name('er_registration.store');
        ...
        Route::get('/check-active-token', [FrontDeskRegistrationController::class, 'checkActiveToken'])->name('check.active.token');
        Route::post('/opd-slots', [FrontDeskRegistrationController::class, 'getOpdSlots'])->name('opd.slots');
