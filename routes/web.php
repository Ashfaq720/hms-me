...
// Logged-in user's own profile view (reuses the backend.users.show template)
...
Route::middleware('auth')->prefix('health-card')->name('health-card.')->group(function () {
    ...
    Route::get('lab-investigations',  [HealthCardController::class, 'labInvestigations'])->name('lab-investigations');
...
Route::middleware(['auth'])->group(function () {
    Route::resource('opd-patient-departments', OpdPatientDepartmentController::class);
});
...
// AJAX charge helpers called from authenticated forms — guard them
Route::middleware(['auth'])->group(function () {
