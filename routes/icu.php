...
use App\Http\Controllers\ICU\IcuCodeBlueController;
...
Route::prefix('icu')
    ...
    ->group(function () {
        ...
        Route::get('/orders/{orderId}', [IcuDoctorOrderController::class, 'show'])->name('orders.show');
        ...
        // Nursing notes
        Route::get('/nursing-notes/manage', [IcuNursingNoteController::class, 'manage'])->name('nursing-notes.manage');
        ...
        // Intake / Output
        Route::get('/intake-output/manage', [IcuIntakeOutputController::class, 'manage'])->name('intake-output.manage');
        ...
        // Code Blue listing (cross-admission)
        Route::get('/code-blue', [IcuCodeBlueController::class, 'index'])->name('code-blue.index');
        ...
        // Mortality
        Route::get('/mortality', [IcuMortalityController::class, 'index'])->name('mortality.index');
        Route::get('/admissions/{admissionId}/mortality', [IcuMortalityController::class, 'show'])->name('admissions.mortality.show');
        Route::get('/admissions/{admissionId}/mortality/print', [IcuMortalityController::class, 'print'])->name('admissions.mortality.print');
