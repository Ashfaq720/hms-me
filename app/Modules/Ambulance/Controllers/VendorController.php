...
class VendorController extends Controller
{
    ...
    {
        if ($vendor->ambulances()->exists()) {
            return redirect()->route('amb.vendors.index')
                ->with('error', 'Cannot delete vendor — ' . $vendor->ambulances()->count() . ' ambulance(s) are linked. Reassign or remove them first.');
        }
