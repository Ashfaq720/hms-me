...
class IcuPathologyOrderController extends Controller
{
    ...
    public function index($admissionId)
    {
        ...
        return view('icu.pathology-order.index', compact('admission', 'orders'));
    }
    ...
    public function create($admissionId)
    {
        ...
        return view('icu.pathology-order.create', compact(
            'admission',
            'doctors',
            'investigationTypes',
            'categories',
    ...
    public function show($admissionId, $orderId)
    {
        ...
        return view('icu.pathology-order.show', compact('admission', 'order'));
    }
    ...
    public function edit($admissionId, $orderId)
    {
        ...
        return view('icu.pathology-order.edit', compact(
            'admission',
            'order',
            'doctors',
            'investigationTypes',
