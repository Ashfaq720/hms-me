...
use App\Policies\Ot\OtSurgeryRequestPolicy;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        // Resource-level Policies — Super Admin/Admin still bypass via
        // Gate::before() in PermissionServiceProvider.
        Gate::policy(Patient::class, PatientPolicy::class);
        Gate::policy(OtSurgeryRequest::class, OtSurgeryRequestPolicy::class);
    }
}
