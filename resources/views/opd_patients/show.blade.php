...
@section('content')
            ...
            <div class="card-header bg-white border-bottom py-3 px-3 px-md-4">
                <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between gap-3">
                    ...
                    <div class="d-flex flex-wrap gap-2 header-actions">
                        ...
                        {{-- Unified Lab Order — replaces separate Pathology + Radiology modals.
                             Supports all 9 lab investigation types in one form with multi-line entries. --}}
                        <a href="{{ route('opd-patients.lab-orders.create', $opdPatient->id) }}" class="btn btn-sm btn-outline-danger">
                            <i class="bi bi-clipboard2-pulse me-1"></i><span class="btn-text">New Lab Order</span>
                            <small class="opacity-75">(all 9 types)</small>
                        </a>
                    </div>
                </div>
            </div>
    ...
    {{-- DEPRECATED — Radiology Entry Modal (replaced by unified /opd-patients/{id}/lab-orders/create form) --}}
    @if (false)
    ...
    @endif {{-- end deprecated lab modals --}}
@endsection
