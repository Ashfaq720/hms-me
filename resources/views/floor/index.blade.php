        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
                    <div class="clearfix">
                        <h1 class="app-page-title">Floor</h1>
                    </div>

                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                        data-bs-target="#floorModal" data-mode="create" data-title="Create Floor"
                        data-action="{{ route('floors.store') }}">
                        <i class="fi fi-rr-plus me-1"></i> Add Floor
                    </button>
                    ...
                    <div class="col-12">
                        <div class="card overflow-hidden">
                            <div
                                ...
                                <h6 class="card-title mb-2">Floor List</h6>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="d-flex flex-wrap gap-1 justify-content-start">
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-warning"
                                                            ...
                                                            data-mode="edit" data-title="Edit Floor"
                                                            data-action="{{ route('floors.update', $p) }}"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header d-flex align-items-center">
                        <h5 class="modal-title" id="floorModalTitle">Floor</h5>
                        {{-- <button type="button" class="btn-close" data-bs-dismiss="modal"></button> --}}
                    </div>

                    <form id="floorForm" method="POST" action="{{ route('floors.store') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="modal-body">
                            @include('floor._form', ['floor' => null])
                        </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const nameInp = document.getElementById('floor_name');
