...
@php
    $displayType   = !empty($typeName) ? $typeName : 'All';
    $createLabel   = $pathologyType?->name ?? (!empty($typeName) ? $typeName : 'Pathology');
    $listingTitle  = !empty($typeName) ? $typeName . ' Orders' : 'All Diagnostic Orders';
@endphp
...
@section('content')
    <div class="container-fluid">
        <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
            <div class="clearfix">
                <h1 class="app-page-title">{{ $listingTitle }}</h1>
            </div>
            <div>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#createModal">
                    <i class="bi bi-plus-lg me-1"></i> Create {{ $createLabel }} Order
                </button>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card overflow-hidden">
                    <div
                        ...
                        <h6 class="card-title mb-2">{{ $listingTitle }}</h6>
                    ...
                    <div class="card-body px-3 pt-2 pb-0 gradient-layer">
                        <table id="pathologyTable" class="table display table-row-rounded">
                            ...
                            <tbody id="pathologyTbody">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="11" class="text-center">No {{ strtolower($displayType) }} orders found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="modal-content">
                    <form action="{{ route('pathology.store') }}" method="POST">
                        ...
                        <div class="modal-header d-flex align-items-center">
                            <h5 class="modal-title">Create {{ $createLabel }} Order</h5>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // loses focus to Bootstrap's modal focus trap. Initialised lazily
            // so the modal renders quickly.
