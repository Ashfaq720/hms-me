                    ...
                    <div class="card-header bg-white border-bottom py-3 px-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            ...
                            <a data-size="md" class="btn btn-primary btn-sm px-3 d-inline-flex align-items-center"
                                data-url="{{ route('admin.unite-types.create') }}" data-ajax-popup="true"
                                data-title="Create Unite Type" data-bs-toggle="tooltip" title="Create Unite Type">
                                            ...
                                            <td class="py-3 text-center">
                                                <div class="d-inline-flex align-items-center gap-1">
                                                    ...
                                                    <a data-size="md" class="btn btn-sm btn-outline-warning action-btn"
                                                        data-url="{{ route('admin.unite-types.edit', $p->id) }}"
                                                        data-ajax-popup="true" data-title="Edit Unite Type"
                                                        data-bs-toggle="tooltip" title="Edit Unite Type">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>

                                                    <form method="POST"
                                                        action="{{ route('admin.unite-types.destroy', $p->id) }}"
