            ...
            <div class="col-lg-9 col-md-8">
                ...
                <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
                    ...
                    <button type="button" class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal"
                        data-bs-target="#floorModal" data-mode="create" data-title="Create Department"
                        data-action="{{ route('departments.store') }}">
                    ...
                    <div class="col-12">
                        <div class="card overflow-hidden">
                            <div
                                ...
                                <h6 class="card-title mb-2">Department List</h6>
                                                ...
                                                <td class="text-nowrap">
                                                    <div class="d-flex flex-wrap gap-1 justify-content-start">
                                                        <a href="javascript:void(0)" class="btn btn-sm btn-warning"
                                                            ...
                                                            data-mode="edit" data-title="Edit Department"
                                                            data-action="{{ route('departments.update', $p) }}"
                                                        ...
                                                        <form title="Delete" method="POST"
                                                            action="{{ route('departments.destroy', $p) }}"
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-header d-flex align-items-center">
                        <h5 class="modal-title" id="floorModalTitle">Department</h5>
                        {{-- <button type="button" class="btn-close" data-bs-dismiss="modal"></button> --}}
                    </div>

                    <form id="floorForm" method="POST" action="{{ route('departments.store') }}" enctype="multipart/form-data">
                        @csrf
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                modalEl.addEventListener('show.bs.modal', function(event) {
                    ...
                    titleEl.innerText = title || 'Department';
