...
@section('title','New Surgery Category')
@section('content')
<div class="container-fluid">
    <h1 class="app-page-title mb-3">New Surgery Category</h1>
    @if($errors->any())<div class="alert alert-danger"><ul class="mb-0">@foreach($errors->all() as $e)<li>{{ $e }}</li>@endforeach</ul></div>@endif
    <form action="{{ route('ot.setup.surgery-categories.store') }}" method="POST">@csrf
