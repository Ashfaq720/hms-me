...
<div class="row g-3">
    ...
    <div class="col-md-3 d-flex align-items-end">
        <div class="form-check"><input type="hidden" name="is_active" value="0"><input class="form-check-input" type="checkbox" name="is_active" value="1" id="actSc" @checked(old('is_active', $i->is_active ?? true))><label class="form-check-label" for="actSc">Active</label></div>
    </div>
