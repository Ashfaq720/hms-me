                ...
                <div class="card border-0 shadow-sm rounded-3 overflow-hidden">
                    ...
                    <div class="card-header bg-white border-bottom py-3 px-4">
                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                            <div>
                                <h5 class="mb-1 fw-semibold text-dark">Charge Type</h5>
                                <p class="mb-0 text-muted small">Manage all Charge Types from here</p>
                            </div>

                            <a data-size="md" class="btn btn-primary btn-sm px-3 d-inline-flex align-items-center"
                                data-url="{{ route('admin.charge-types.create') }}" data-ajax-popup="true"
                                data-title="Create Charge Type" data-bs-toggle="tooltip" title="Create Charge Type">
                                <i class="bi bi-plus-lg me-1"></i> Create Charge Type
                            </a>
                        </div>
                    </div>
                                            ...
                                            <td class="py-3 text-center">
                                                <div class="d-inline-flex align-items-center gap-1">
                                                    ...
                                                    <a data-size="md" class="btn btn-sm btn-outline-warning action-btn"
                                                        data-url="{{ route('admin.charge-types.edit', $ct->id) }}"
                                                        data-ajax-popup="true" data-title="Edit Charge Type"
                                                        data-bs-toggle="tooltip" title="Edit Charge Type">
                                                        <i class="fa-solid fa-pen-to-square"></i>
                                                    </a>

                                                    <form method="POST"
                                                        action="{{ route('admin.charge-types.destroy', $ct->id) }}"
