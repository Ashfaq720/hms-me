                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted mb-1">User Type</label>
                                <p class="mb-0">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted mb-1">Roles</label>
                                <p class="mb-0">
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted mb-1">Current Organization</label>
                                <p class="mb-0">{{ $user->currentOrganization?->name ?? '—' }}</p>
                            </div>

                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted mb-1">Current Branch</label>
                                <p class="mb-0">{{ $user->currentBranch?->name ?? '—' }}</p>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p class="mb-0">
                                    @if ($user->email_verified_at)
                                        ...
                                        <small class="text-muted ms-1">{{ format_date($user->email_verified_at) }}</small>
                                    @else
                            ...
                            <div class="col-md-6 mb-3">
                                <label class="form-label text-muted mb-1">Joined</label>
                                <p class="mb-0">
