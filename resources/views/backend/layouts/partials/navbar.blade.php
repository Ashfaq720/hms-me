            ...
            <div class="dropdown text-end ms-sm-3 ms-2 ms-lg-4">
                <a href="#" class="d-flex align-items-center py-2" data-bs-toggle="dropdown"
                    ...
                    <div class="text-end me-2 d-none d-lg-inline-block">
                        ...
                        <small class="text-body d-block lh-sm">
                            <i class="fi fi-rr-angle-down text-3xs me-1"></i> {{ strtoupper(auth()->user()->type ?? '') }}
                        </small>
                    </div>
                ...
                <ul class="dropdown-menu dropdown-menu-end w-225px mt-1">
                    <li class="d-flex align-items-center p-2">
                        <div class="avatar avatar-sm rounded-circle d-lg-none">
                            <img src="{{ asset('backend/assets/images/avatar/avatar1.webp') }}" alt="">
                        </div>
                        <div class="ms-2">
                            <div class="fw-bold text-dark d-lg-none">{{ auth()->user()->name ?? 'User' }}</div>
                            <small class="text-body d-block lh-sm d-lg-none">{{ strtoupper(auth()->user()->type ?? '') }}</small>
                            <span class="text-body d-block lh-sm small d-lg-none">{{ auth()->user()->email ?? '' }}</span>
                            <span class="text-body d-block lh-sm d-none d-lg-block"><i class="fi fi-rr-envelope me-1"></i>{{ auth()->user()->email ?? '' }}</span>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <form action="{{ route('logout') }}" method="POST" class="d-inline">
                            @csrf
                            <button type="submit" class="dropdown-item d-flex align-items-center gap-2 text-danger" style="border: none; background: none; cursor: pointer;">
