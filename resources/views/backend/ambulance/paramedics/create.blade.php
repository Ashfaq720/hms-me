...
<div class="container">
    ...
    <div class="card mt-4">
        <div class="card-body">
            <form action="{{ route('amb.paramedics.store') }}" method="POST">
                @csrf
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="skill_level" class="form-select @error('skill_level') is-invalid @enderror" required>
                            <option value="BASIC"    @selected(old('skill_level','BASIC') == 'BASIC')>Basic</option>
                ...
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary">Save Paramedic</button>
                    <a href="{{ route('amb.paramedics.index') }}" class="btn btn-light ms-2">Cancel</a>
                </div>
            </form>
        </div>
    </div>
