...
<div class="container">
    <div class="app-page-head d-flex flex-wrap gap-3 align-items-center justify-content-between">
        <h1 class="app-page-title">Add Ambulance</h1>
        ...
        <div class="card-body">
            <form action="{{ route('amb.ambulances.store') }}" method="POST">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="reg_no"
                            ...
                            value="{{ old('reg_no') }}" placeholder="DHAKA-METRO-GA-1234" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="type" id="amb_type"
                            ...
                            <option value="ICU"       @selected(old('type') == 'ICU')>ICU</option>
                            <option value="NEONATAL"  @selected(old('type') == 'NEONATAL')>Neonatal</option>
                        </select>
                        @error('type')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        <div id="equipment_warning" class="form-text text-warning d-none">
                            <i class="bi bi-exclamation-triangle-fill"></i> ALS/ICU/Neonatal requires equipment mapping after save (AMB-BR-004).
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="ownership" id="ownership"
                            ...
                            <option value="HOSPITAL"   @selected(old('ownership','HOSPITAL') == 'HOSPITAL')>Hospital Owned</option>
                    ...
                    {{-- Vendor (shown only when Outsourced) --}}
                    <div class="col-md-4" id="vendor_field" style="{{ old('ownership') === 'OUTSOURCED' ? '' : 'display:none' }}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="stretcher_capacity" min="1"
                            ...
                            value="{{ old('stretcher_capacity', 1) }}" required>
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" name="attendants_capacity" min="0"
                            ...
                            value="{{ old('attendants_capacity', 1) }}" required>
                        @error('attendants_capacity')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>

                    <div class="col-md-2">
                        <label class="form-label">Oxygen Capacity</label>
                        <input type="text" name="oxygen_capacity"
                            class="form-control" value="{{ old('oxygen_capacity') }}" placeholder="e.g. 10L">
                    </div>
                ...
                <div class="mt-4">
                    ...
                    <a href="{{ route('amb.ambulances.index') }}" class="btn btn-light ms-2">Cancel</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="alert alert-info mt-3">
        ...
        Equipment mapping is available on the detail page after saving. ALS, ICU, and Neonatal ambulances <strong>must</strong> have equipment mapped (AMB-BR-004).
    </div>
</div>
...
<script>
    ...
    document.getElementById('amb_type').addEventListener('change', function () {
        const needs = ['ALS', 'ICU', 'NEONATAL'].includes(this.value);
        document.getElementById('equipment_warning').classList.toggle('d-none', !needs);
    });
</script>
@endpush
@endsection
