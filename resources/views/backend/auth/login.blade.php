...
<style>
    /* Login page sizing:
       — Page allowed to scroll only if absolutely necessary (rare now that
         the card is compact). Box itself does NOT scroll.
       — Card is centred vertically when there's room, top-aligned on
         very short screens. */
    html, body { height: auto !important; overflow-y: auto !important; }
    .page-layout { min-height: 100vh; overflow: visible !important; }
    .auth-wrapper { min-height: 100vh; }
    .auth-wrapper .container-fluid { align-items: center !important; }
    @media (max-height: 720px) {
        .auth-wrapper .container-fluid { align-items: flex-start !important; }
    }
    /* The login card never scrolls internally */
    .auth-wrapper .card { overflow: visible !important; }
    .auth-wrapper .card .card-body { overflow: visible !important; }
    /* Tighten Bootstrap defaults slightly inside the form */
    .auth-wrapper .input-group-text { padding: .45rem .65rem; }
    .auth-wrapper .form-control     { padding: .5rem .65rem; }
    .auth-wrapper .btn              { padding: .55rem .9rem; }
</style>
@endpush
                        ...
                        <div class="col-12 col-md-10 col-lg-6 col-xl-5">
                            ...
                            <div class="mx-auto w-100">
                                ...
                                <div class="card border-0 rounded-4 overflow-hidden shadow-lg">
                                    ...
                                    {{-- Header (compact) --}}
                                    <div class="px-4 pt-4 pb-3 text-center bg-light">
                                        <div class="d-flex justify-content-center align-items-center mb-2"
                                             style="min-height:56px;">
                                            <a href="#" aria-label="{{ setting('company_name') }} logo"
                                        ...
                                        <p class="mb-0 small text-muted">Sign in to your {{ setting('company_name') }} dashboard.</p>
                                    </div>
                                    ...
                                    <div class="card-body px-4 py-3">
                                        ...
                                        <form action="{{ route('login') }}" method="POST" id="hmsLoginForm" novalidate>
                                            ...
                                            {{-- Email --}}
                                            <div class="mb-2">
                                                <label class="form-label fw-semibold small mb-1" for="loginEmail">Email</label>
                                            ...
                                            {{-- Password --}}
                                            <div class="mb-2">
                                                <label class="form-label fw-semibold small mb-1" for="loginPassword">Password</label>
                                                <div class="input-group">
                                                    <span class="input-group-text bg-transparent">
                                                ...
                                                @error('password')
                                                    <div class="invalid-feedback d-block small">{{ $message }}</div>
                                                @enderror
                                                <div class="d-none mt-1 small text-warning" id="capsHint">
                                            ...
                                            {{-- Submit --}}
                                            <button type="submit" class="btn btn-primary w-100 rounded-3" id="loginBtn">
                                                <i class="fa-solid fa-right-to-bracket me-2"></i>
                                                <span id="loginBtnText">Login</span>
                                            </button>

                                            {{-- Super Admin quick-fill (dev only) --}}
                                            <button type="button"
                                                class="btn btn-link btn-sm w-100 mt-2 text-decoration-none text-muted"
                                                id="superAdminBtn"
                                                title="Quick-fill admin credentials (dev only)">
                                                <i class="fa-solid fa-user-shield me-1"></i>Use Super Admin (dev)
                                            </button>
                                        </form>
                                    </div>
