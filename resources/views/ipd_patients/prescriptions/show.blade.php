...
@section('content')
    <div class="rx-page">
        <div class="container">
            ...
            {{-- Back button --}}
            <div class="mb-2">
                <a href="{{ route('ipd-patients.show', $ipdPatient->id) }}" class="btn btn-sm btn-light">
            ...
            {{-- ══════════ FOOTER BUTTONS ══════════ --}}
            <div class="rx-footer">
                <a href="{{ route('ipd-patients.show', $ipdPatient->id) }}" class="btn btn-secondary px-4">
                    <i class="bi bi-arrow-left"></i> Back to Patient
                </a>
                <a href="{{ route('ipd-patients.prescriptions.pdf', [$ipdPatient->id, $prescription->id]) }}" target="_blank" class="btn btn-warning px-4 fw-bold">
