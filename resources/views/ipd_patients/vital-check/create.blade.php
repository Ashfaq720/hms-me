<form action="{{ route('ipd-patients.vital-checks.store', $id) }}" method="POST">
    @csrf
    ...
    <div class="row g-3">
        ...
        {{-- Blood Pressure --}}
        <div class="col-12 col-lg-6">
            <label class="form-label">Blood Pressure <span class="text-muted">(mmHg)</span> <span class="text-danger">*</span></label>
            <input type="text" name="blood_pressure" class="form-control @error('blood_pressure') is-invalid @enderror"
                value="{{ old('blood_pressure') }}" placeholder="120/80" required>
        ...
        {{-- Temperature --}}
        <div class="col-12 col-lg-6">
            <label class="form-label">Temperature <span class="text-muted">(°F)</span> <span class="text-danger">*</span></label>
            <input type="number" step="0.01" name="temperature"
                class="form-control @error('temperature') is-invalid @enderror"
                value="{{ old('temperature') }}" placeholder="Enter Temperature" required>
            @error('temperature')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        {{-- Heart Rate --}}
        <div class="col-12 col-lg-6">
            <label class="form-label">Heart Rate <span class="text-muted">(bpm)</span> <span class="text-danger">*</span></label>
            <input type="number" name="heart_rate" class="form-control @error('heart_rate') is-invalid @enderror"
                value="{{ old('heart_rate') }}" placeholder="Enter Heart Rate" required>
            @error('heart_rate')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        {{-- SPO2 --}}
        <div class="col-12 col-lg-6">
            <label class="form-label">SPO2 <span class="text-muted">(%)</span> <span class="text-danger">*</span></label>
            <input type="number" name="spo2" class="form-control @error('spo2') is-invalid @enderror"
                value="{{ old('spo2') }}" placeholder="Enter Spo2" required>
            @error('spo2')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="col-12 col-lg-12">
            <label class="form-label">Respiratory Rate <span class="text-muted">(breaths/min)</span> <span class="text-danger">*</span></label>
            <input type="number" name="respiratory_rate"
                class="form-control @error('respiratory_rate') is-invalid @enderror"
                value="{{ old('respiratory_rate') }}" placeholder="Enter Respiratory Rate" required>
