                            ...
                            <tbody>
                                @forelse($ipdPatients as $index => $ipd)
                                    <tr class="ipd-row" data-index="{{ $index }}">
                                        ...
                                        <td>
                                            @php $isAdmitted = in_array(strtolower((string) $ipd->status), ['admitted', 'active']); @endphp
                                            <span class="badge bg-{{ $isAdmitted ? 'success' : 'warning' }}">{{ ucfirst($ipd->status ?? '') }}</span>
                                        </td>
                                                        ...
                                                        @if (!$currentIsIcu)
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    data-url="{{ route('ipd-patients.icu-transfer', $ipd->id) }}?type=ICU"
                                                                    data-size="xl" data-ajax-popup="true"
                                                                    data-title="Transfer to ICU">
                                                            ...
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    ...
                                                                    data-url="{{ route('ipd-patients.icu-transfer', $ipd->id) }}?type=NICU"
                                                                    data-size="xl" data-ajax-popup="true"
                                                                    data-title="Transfer to NICU">
                                                                    <i class="bi bi-emoji-smile me-2"></i> Transfer to NICU
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="javascript:void(0);"
                                                                    class="dropdown-item text-danger"
                                                                    data-url="{{ route('ipd-patients.icu-transfer', $ipd->id) }}?type=CCU"
                                                                    data-size="xl" data-ajax-popup="true"
                                                                    data-title="Transfer to CCU">
                                                                    <i class="bi bi-heart me-2"></i> Transfer to CCU
                                                                </a>
                                                            </li>
                                                        @endif
