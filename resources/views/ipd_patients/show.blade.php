                    ...
                    <ul class="nav nav-tabs flex-nowrap border-bottom-0" id="ipdTabs" role="tablist" style="white-space: nowrap;">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex align-items-center gap-2" id="lab-tab" data-bs-toggle="tab"
                                ...
                                <i class="bi bi-clipboard2-pulse"></i> <span>Pathology Order</span>
                            </button>
                        </li>

                        <li class="nav-item" role="presentation">
                            <button class="nav-link d-flex align-items-center gap-2" id="radiology-tab" data-bs-toggle="tab"
                                data-bs-target="#radiology" type="button" role="tab">
                                <i class="bi bi-clipboard2-pulse"></i> <span>Radiology Order</span>
                            </button>
                        </li>
            ...
            <div class="card-body">
                <div class="tab-content" id="ipdTabContent">
                    ...
                    <div class="tab-pane fade" id="lab" role="tabpanel">
                        <x-ipd.pathology-orders :iPDPatient="$iPDPatient" />
                    </div>

                    {{-- Radiology Order --}}
                    <div class="tab-pane fade" id="radiology" role="tabpanel">
                        <x-ipd.radiology-orders :iPDPatient="$iPDPatient" />
                    </div>
