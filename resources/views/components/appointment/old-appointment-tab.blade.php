<div class="card-body bg-white p-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
        <div class="search-box-wrap">
            <input type="text" class="form-control form-control-sm search-input"
                placeholder="Search old appointments...">
        </div>
    </div>

    {{-- Old Appointment Table --}}
    <div class="table-responsive apt-table-wrap">
        <table class="table table-sm align-middle apt-table mb-0">
            ...
            <tbody>
                @forelse($old_appointments ?? [] as $key => $ap)
                    <tr>
                        <td>{{ $key + 1 }}</td>
                        ...
                        <td class="text-end">
                            <div class="d-inline-flex gap-1">
                                ...
                                <form action="{{ route('appointments.destroy', $ap->id) }}?tab=old"
                ...
                @empty
                    <tr>
                        <td colspan="12" class="text-center text-muted py-4">No old appointments found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 table-footer mt-2 pt-3 border-top">
        <div class="record-info">
            Records: {{ isset($old_appointments) ? $old_appointments->count() : 0 }}
        </div>
    </div>
</div>
