<div class="card-body bg-white p-3">
    ...
    <div class="table-responsive opd-table-wrap">
        <table class="table table-sm align-middle opd-table mb-0">
            ...
            <tbody>
                @forelse($upcoming_opd_patients ?? [] as $key => $patient)
                    <tr>
                        <td><a
                        ...
                        <td>
                            {{ !empty($patient->appointment_date) ? \Carbon\Carbon::parse($patient->appointment_date)->format('d M Y h:i A') : 'N/A' }}
                        </td>
                        ...
                        <td>
                            <span class="badge status-badge bg-info-subtle text-info">Upcoming</span>
                        </td>
                        <td class="text-end">
    ...
    <div
        ...
        <div class="record-info">
            Records:
            {{ isset($upcoming_opd_patients) ? $upcoming_opd_patients->count() : 0 }}
        </div>
