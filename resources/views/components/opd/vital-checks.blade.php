<div class="table-responsive">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a data-size="lg" class="btn btn-primary px-2 w-100 w-sm-auto"
                data-url="{{ route('opd-patients.vital-checks', $opdPatient->id) }}" data-ajax-popup="true"
    ...
    <table class="table table-sm table-bordered align-middle">
        <thead class="table-light">
            <tr>
                ...
                <th width="8%">Temp</th>
                <th width="8%">Heart Rate</th>
                <th width="8%">SpO2</th>
                <th width="9%">Resp Rate</th>
                <th width="10%">Checked By</th>
            </tr>
        </thead>
        <tbody>
            @forelse ($opdPatient->vitalChecks as $vital)
                <tr>
    ...
    <div class="mt-4">
        ...
        <div class="position-relative" style="padding-left: 40px;">
            ...
            @foreach ($opdPatient->vitalChecks->sortByDesc('checked_at') as $vital)
