...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
       ...
       $modules = [
            ...
            'OT Management' => [
                ['name' => 'ot_dashboard_access', 'guard_name' => 'web'],
                ['name' => 'ot_surgery_request_access', 'guard_name' => 'web'],
                ['name' => 'ot_surgery_request_create', 'guard_name' => 'web'],
                ['name' => 'ot_surgery_request_edit', 'guard_name' => 'web'],
                ['name' => 'ot_surgery_request_review', 'guard_name' => 'web'],
                ['name' => 'ot_surgery_request_delete', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_access', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_create', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_edit', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_approve', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_cancel', 'guard_name' => 'web'],
                ['name' => 'ot_schedule_reschedule', 'guard_name' => 'web'],
                ['name' => 'ot_pre_op_access', 'guard_name' => 'web'],
                ['name' => 'ot_pre_op_edit', 'guard_name' => 'web'],
                ['name' => 'ot_pre_op_complete', 'guard_name' => 'web'],
                ['name' => 'ot_pre_op_override', 'guard_name' => 'web'],
                ['name' => 'ot_transfer_access', 'guard_name' => 'web'],
                ['name' => 'ot_transfer_create', 'guard_name' => 'web'],
                ['name' => 'ot_room_access', 'guard_name' => 'web'],
                ['name' => 'ot_room_manage', 'guard_name' => 'web'],
                ['name' => 'ot_team_access', 'guard_name' => 'web'],
                ['name' => 'ot_team_manage', 'guard_name' => 'web'],
                ['name' => 'ot_anesthesia_access', 'guard_name' => 'web'],
                ['name' => 'ot_anesthesia_edit', 'guard_name' => 'web'],
                ['name' => 'ot_intra_op_access', 'guard_name' => 'web'],
                ['name' => 'ot_intra_op_edit', 'guard_name' => 'web'],
                ['name' => 'ot_consumables_access', 'guard_name' => 'web'],
                ['name' => 'ot_consumables_edit', 'guard_name' => 'web'],
                ['name' => 'ot_post_op_access', 'guard_name' => 'web'],
                ['name' => 'ot_post_op_edit', 'guard_name' => 'web'],
                ['name' => 'ot_pacu_access', 'guard_name' => 'web'],
                ['name' => 'ot_pacu_edit', 'guard_name' => 'web'],
                ['name' => 'ot_billing_access', 'guard_name' => 'web'],
                ['name' => 'ot_billing_post', 'guard_name' => 'web'],
                ['name' => 'ot_inventory_access', 'guard_name' => 'web'],
                ['name' => 'ot_cleaning_access', 'guard_name' => 'web'],
                ['name' => 'ot_cleaning_manage', 'guard_name' => 'web'],
                ['name' => 'ot_documents_access', 'guard_name' => 'web'],
                ['name' => 'ot_documents_upload', 'guard_name' => 'web'],
                ['name' => 'ot_emergency_access', 'guard_name' => 'web'],
                ['name' => 'ot_emergency_create', 'guard_name' => 'web'],
                ['name' => 'ot_emergency_approve', 'guard_name' => 'web'],
                ['name' => 'ot_reports_access', 'guard_name' => 'web'],
                ['name' => 'ot_audit_access', 'guard_name' => 'web'],
                ['name' => 'ot_setup_access', 'guard_name' => 'web'],
                ['name' => 'ot_setup_manage', 'guard_name' => 'web'],
            ],
        ];
